...
describe("A spy and it's methods,", function() {
    ...
    beforeEach(function() {
        ...
        // the below is the "mocked" api data, which will replace the actual api
        // call
        Spy.api_data = {
            data : {
                'George' : '006',
        ...
        // this is the spy creation, we are spying on the actual function
        // implementation
        spyOn(Spy, 'call_api');

        // use callThrough(), so you can follow through the full code
        // implemention on the code chain
        Spy.call_api.and.callThrough();

        // both spy names below exist in our mocked api data, so will return
        // spy ids
    ...
    it("when called, returns the requested value", function() {
        ...
        expect(api_return_fred).toEqual('No knowledge of the existence of this one.');
        expect(api_return_error).toEqual('No knowledge of the existence of this one.');
    });
